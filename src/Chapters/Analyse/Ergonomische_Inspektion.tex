...
Das in der Silvanet-Schnittstelle verwendete Designsystem, PrimeNG, bietet eine Skeleton-Komponente out of the box und wird eine einfache Implementierungslösung für dieses Issue ermöglichen.

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{primeng_skeletons}
  \caption{Beispiel für \ac{UI}-Komponenten-Skeletons, die vom Designsystem PrimeNG bereitgestellt werden}
