...
Diese Probleme wurden mithilfe von Tickets im ClickUp-Tool\footnote{Siehe \ref{sec:clickup}} in verschiedene Aufgaben aufgeteilt, die unter den verschiedenen Entwicklern aufgeteilt, nach Relevanz und Schwierigkeit der Implementierung priorisiert und schließlich im Scrum-Flow\footnote{Siehe \ref{sec:scrum}} verwendet wurden.
Ein Teil der Aufgaben, die sich aus dieser Forschungsarbeit ergeben und die mir zugewiesen wurden, werden im Teil Konzeption\footnote{Siehe \ref{chap:konzeption}} der Thesis vorgestellt.
